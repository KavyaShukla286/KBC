...
questions = ["Which is the largest country in the world?",
             ...
             "The plant of which of these edible substance belongs to the lily family?",
             "Which one is the first fully supported 64-bit operating system?",
             "Cow is the national animal of which of the following country?",
             "Which city will host Olympics 2024?",
             ...
             "According to Koran, from what did Allah created the Jinn?",
             "‘Which was the world's first nuclear-powered submarine?"]

first_option = ["India", "500 Years",
                "Heron", "Euro",
                "Javascript", "Onion",
                "Windows 7", "Sri Lanka", "Sydney", "KKR",
                "Nelly Sachs", "Google",
                "Coonhound", "Fire", "Halibut"]

second_option = ["USA", "1000 Years",
                 "Parrot", "Peso ",
                 "Python", "Mint",
                 "Linux", "Nepal", "Beijing", "CSK",
                 "Jane Addams", "Microsoft",
                 "Pointer",
                 "Water", "Triton"]

third_option = ["China", "50 Years",
                "Crow", "Dollar",
                "Java", "Ginger",
                "Mac", "China", "Paris", "MI",
                "Pearl Buck", "Apple",
...
fourth_option = ["Russia", "100 Years",
                 "Pigeon", "Yen",
                 "C++", "Lemon",
                 "Windows XP", "Israel", "New York", "RCB",
                 "Marie Curie",
                 "Amazon",
                 "Bloodhound", "Clay",
                 "Seawolf"]

correct_answers = ["Russia", "1000 Years", "Heron", "Dollar", "Python", "Onion",
                   "Linux", "Nepal", "Paris", "MI", "Marie Curie", "Apple", "Bloodhound", "Fire",
                   "Nautilus"]
